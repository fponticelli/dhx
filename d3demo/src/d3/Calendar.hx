...
import thx.math.scale.Quantize;
using Arrays;
/**
 * ...
...
class Calendar extends Example
{
	...
	override function runExample()
	{
		...
		var day = vis.selectAll("rect.day")
			...
			.enter().append("svg:rect")
				.attr("x").floatf(function(d, i) return d.week * z)
				.attr("y").floatf(function(d, i) return d.day * z)
				.attr("class").string("day")
		...
		vis.selectAll("path.month")
			...
			.enter().append("svg:path")
				.attr("class").string("month")
				.attr("d").stringf(function(d, _) {
		...
		http.onData = function(d : String)
		{
			...
			day
				...
				.append("svg:title")
					.text().stringf(function(d, i) return d.date + ": " + FormatNumber.percent(data.get(d.date)));
		};
		http.request(false);
	}
